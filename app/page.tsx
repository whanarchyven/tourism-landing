...
export default function Home() {
    ...
    const data = {
        ...
        dateStart: '2023-10-14T13:15:35.176Z',
        dateEnd: '2023-10-17T13:15:35.176Z',
        layoutSrc: '/images/layout.jpg',
        description: '### от ART PLANET TRAVEL\n' +
            '\n' +
            'Нас ждёт запоминающееся путешествие в одно из красивейших мест планеты, в Каппадокию с ее сказочными пейзажами и завораживающими видами!\n' +
            '\n' +
            '### Мы организуем этот тур, чтобы:\n' +
            '\n' +
            'Познакомиться со сказочной Каппадокией и увидеть её невероятную красоту своими глазами! Познакомиться с местной культурой, увидеть красивейший вид на долины и пещерные города, прочувствовать весь колорит этого места! И все это — в компании единомышленников в душевной и непринужденной атмосфере! Каппадокия - одно из самых необычных и красивых мест в мире со сказочным лунным ландшафтом, над которым на рассвете взмывают десятки воздушных шаров, с потрясающими подземными городами, пещерными церквями и домами, высеченными прямо в скалах.',
        ...
        organizator: {
            ...
            description: 'Основатель проекта Art Planet, бэкграунд которого более 100 событий: фестивалей, ретритов, экспедиций и осознанных вечеринок. Программный директор Международного дня йоги в Москве (Красная Пресня и Царицыно) 2017-2018 гг.  \n' +
                '  \n' +
                'Практик медитации и проводник осознанного образа жизни. Исполняет исцеляющую музыку. Проводит персональные сессии в вопросах реализации и отношений, направленные на гармонизацию и трансформацию жизни человека.  \n' +
                '  \n' +
                'Более 11 лет в практиках. Лидер и создатель музыкального коллектива ATMANLOVE  \n' +
                '  \n' +
                'Dj Ecstatic Dance. Музыкант-мультиинструменталист: ситар, гитара, перкуссия, вокалист, исполняет и записывает электронную музыку в формате etno-fusion (сочетание электронного звучания и живых инструментов).',
            tours: [
                {
        ...
        reviews: {
            facebook: [{
                ...
                event: '[Art Planet на Байкал (август 2019)](/)',
                profileNickname: 'natalia.kotlyarova',
                profileLink: 'https://www.facebook.com/natalia.kotlyarova',
                avatar: '/images/reviewTemp.png',
                text: 'Они в потоке. Они открывают новые миры для творчества и самопознания. Они помогают соединить сердце, душу и тело и встретиться с новыми интересными гранями себя. Они - это организаторы Art Planet. Дорогие, Andrew Fazleev и команда, спасибо за то, что «проводите», создаёте потоковость... просто являясь самими собой! Вы прекрасны! Обожаю вас! Спасибо, что вы есть!! Благодарю за вчерашний тёплый, семейный и глубокий вечер! 🙌❤️🌸🦄 Анюта и Лена, отдельное спасибо за рождение Эльфийской принцессы 😉 💎🧚♀️🦄 Уже жду новой встречи 😉 #artfridayparty'
            },
                {
                    name: 'Наталия Котлярова',
                    event: '[Art Planet на Байкал (август 2019)](/)',
