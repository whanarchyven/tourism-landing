...
const BeWithUsBlock:FC = () => {
    return (
        <ParallaxProvider>
            <div className={'w-full h-[900px] flex  items-center overflow-hidden justify-center relative'}>
                ...
                <p className={'text-white font-bold uppercase absolute text-center text-8xl'}>ПУТЕШЕСТВУЙ <br/>
                    С НАМИ!</p>
            </div>
        </ParallaxProvider>
    );
